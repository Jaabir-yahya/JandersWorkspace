...
const quickbooks_controller_1 = require("./quickbooks.controller");
...
exports.QuickBooksModule = QuickBooksModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [quickbooks_controller_1.QuickBooksController],
        providers: [quickbooks_service_1.QuickBooksService],
        exports: [quickbooks_service_1.QuickBooksService],
    })
], QuickBooksModule);
//# sourceMappingURL=quickbooks.module.js.map