...
async function main() {
    ...
    const entities = await prisma.$transaction([
        prisma.entity.upsert({
            ...
            create: {
                ...
                type: client_1.EntityType.CUSTOMER,
        ...
        prisma.entity.upsert({
            ...
            create: {
                ...
                tenantId: '00000000-0000-0000-0000-000000000000',
                createdByUserId: defaultUser.id,
                type: client_1.EntityType.SUPPLIER,
    ...
    const txn1 = await prisma.transaction.upsert({
        ...
        create: {
            ...
            reference: 'INV-001',
            metadata: { context: 'Laptop accessories sale', tags: ['electronics', 'cash'] },
            lines: {
                create: [
                    {
    ...
    const txn2 = await prisma.transaction.upsert({
        ...
        create: {
            ...
            paymentStatus: client_1.PaymentStatus.SETTLED,
            reference: 'INV-002',
            metadata: { context: 'Dell Laptop sale', tags: ['electronics', 'laptop', 'mpesa'] },
            lines: {
                create: [
                    {
    ...
    const txn3 = await prisma.transaction.upsert({
        ...
        create: {
            ...
            reference: 'INV-003',
            metadata: { context: 'Phone accessories on credit', tags: ['accessories', 'credit'] },
            lines: {
                create: [
                    {
    ...
    const txn4 = await prisma.transaction.upsert({
        ...
        create: {
            ...
            type: client_1.TxnType.SERVICE,
            currencyCode: 'KES',
            totalAmount: 12000,
            status: client_1.TxnStatus.DRAFT,
            paymentStatus: client_1.PaymentStatus.PENDING,
            reference: 'INV-004',
            metadata: { context: 'Computer repair service', tags: ['service', 'repair'] },
            lines: {
                create: [
                    {
    ...
    const payment2 = await prisma.payment.upsert({
        ...
        create: {
            ...
            metadata: { method: 'MPESA', mpesa_code: 'S234567', phone: '+254723456789' },
        },
    });
