...
function createTxMock() {
  ...
  return {
    ...
    transactionLine: { findMany: jest.fn(), findUnique: jest.fn(), findFirst: jest.fn(), create: jest.fn(), update: jest.fn(), delete: jest.fn() },
    user: { findMany: jest.fn().mockResolvedValue([e2eUser]), findUnique: jest.fn(), findFirst: jest.fn(), create: jest.fn().mockResolvedValue(e2eUser), update: jest.fn(), delete: jest.fn() },
    ...
    payment: { findMany: jest.fn(), findUnique: jest.fn(), findFirst: jest.fn(), create: jest.fn(), update: jest.fn(), delete: jest.fn() },
...
export const PrismaClient = jest.fn().mockImplementation(() => {
  ...
  transaction: {
    ...
    findUnique: jest.fn().mockResolvedValue(null),
    findFirst: jest.fn().mockResolvedValue(null),
    create: jest.fn().mockResolvedValue({ id: 'e2e-txn-001', reference: 'e2e-ref', amount: 500, status: 'POSTED', lines: [], entity: { id: E2E_ENTITY_ID, name: 'Test Entity', phone: null } }),
    update: jest.fn(),
    delete: jest.fn(),
    count: jest.fn().mockResolvedValue(0),
    aggregate: jest.fn().mockResolvedValue({ _count: { id: 0 } }),
