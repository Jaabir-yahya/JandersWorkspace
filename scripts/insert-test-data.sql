...
-- Insert Transactions (RENTAL)
INSERT INTO transactions (id, tenant_id, entity_id, type, currency_code, status, payment_status, created_by_user_id, metadata)
VALUES 
    (
        '20000000-0000-0000-0000-000000000000004',
        '00000000-0000-0000-0000-000000000001',
        '10000000-0000-0000-0000-000000000001',
        'RENTAL',
        'KES',
...
-- Post some transactions (update status to POSTED)
UPDATE transactions SET status = 'POSTED' WHERE id IN (
    '20000000-0000-0000-0000-000000000001',
    '20000000-0000-0000-0000-000000000003'
);
...
UPDATE transactions SET payment_status = 'SETTLED' WHERE id = '20000000-0000-0000-0000-000000000003';
