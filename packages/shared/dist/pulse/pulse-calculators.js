...
exports.PulseCalculators = void 0;
class PulseCalculators {
    /**
     * Calculates the core "Money Pulse" from a set of account balances.
     */
    static calculateMoneyPulse(balances) {
     ...
     */
    static getCollectionUrgency(debtors) {
        return debtors
            .filter(d => d.amount > 0)
            .map(d => ({
            ...d,
...
exports.PulseCalculators = PulseCalculators;
