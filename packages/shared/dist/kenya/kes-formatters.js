...
exports.getVatBreakdown = getVatBreakdown;
exports.requiresVatRegistration = requiresVatRegistration;
exports.roundToNearestShilling = roundToNearestShilling;
exports.amountInWords = amountInWords;
// Standard VAT rate in Kenya
exports.KENYA_VAT_RATE = 0.16;
/**
...
function formatKes(amount, options = {}) {
    const { symbol = true, decimals = 2, thousandsSeparator = ',', decimalSeparator = '.', } = options;
    ...
    const formattedWhole = wholePart.replace(/\B(?=(\d{3})+(?!\d))/g, thousandsSeparator);
    // Build the result
 ...
 */
function calculateVatFromGross(grossAmount, vatRate = exports.KENYA_VAT_RATE) {
 ...
 * @returns The VAT amount
 */
function calculateVatFromNet(netAmount, vatRate = exports.KENYA_VAT_RATE) {
 ...
 */
function addVat(netAmount, vatRate = exports.KENYA_VAT_RATE) {
    if (isNaN(netAmount)) {
        return 0;
    }
 ...
 */
function removeVat(grossAmount, vatRate = exports.KENYA_VAT_RATE) {
    if (isNaN(grossAmount) || grossAmount <= 0) {
        return 0;
    }
 ...
 */
function getVatBreakdown(grossAmount, vatRate = exports.KENYA_VAT_RATE) {
 ...
 */
function requiresVatRegistration(annualTurnover) {
 ...
 */
function roundToNearestShilling(amount) {
