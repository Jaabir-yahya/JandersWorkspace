 ...
 */
export function extractAmount(sms: string): number {
 ...
 */
export function extractPhoneNumber(sms: string): string {
 ...
 */
export function extractTransactionType(sms: string): 'sent' | 'received' {
 ...
 */
export function extractTimestamp(sms: string): Date {
 ...
 */
export function parseMpesaSms(sms: string): MpesaTransaction {
  if (!isMpesaSms(sms)) {
